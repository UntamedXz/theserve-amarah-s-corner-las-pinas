        ...
        <div class="container">
            ...
            <div class="container-right">
                <div class="container-right-cont">
                    <?php
                    $getProduct = mysqli_query($conn, "SELECT subcategory.subcategory_title, product.product_img1, product.product_title, product.product_price FROM product LEFT JOIN subcategory ON product.subcategory_id=subcategory.subcategory_id WHERE product.category_id = $decode_id");
